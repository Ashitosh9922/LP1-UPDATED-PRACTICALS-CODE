...
FileInputStream("src/practical1/Symtable.txt"))); 
        ...
        br.close(); 
        br = new BufferedReader(new InputStreamReader(new 
FileInputStream("src/practical1/LitTable.txt"))); 
        while((s = br.readLine()) != null) { 
            StringTokenizer st = new StringTokenizer(s, "\t", false); 
...
FileInputStream("src/practical1/output_pass1.txt"))); 
        out_pass2 = new PrintWriter(new 
FileWriter("src/practical2/output_pass2.txt"), true); 
        String s; 
    ...
    public static void main(String[] args) throws Exception { 
        System.out.println("Sakshi Malusare TACO22150"); 
        initiallizeTables(); 
        pass2(); 
    } 
} 
